...
# Aynısının matplotlib-de komutu:
df["sex"].value_counts().plt(kind='bar')
plt.show()

# Kategorik bir görselleştirme yapıldığında seaborn ve matplotlib kullanırız.


# Sayısal değişken Görselleştirme

# Kutu grafik gösterimi
